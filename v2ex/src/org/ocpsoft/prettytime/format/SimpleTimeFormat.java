...
public class SimpleTimeFormat implements TimeFormat
{
   ...
   {
      if (duration.isInFuture() && futureSingularName != null && !TextUtils.isEmpty(futureSingularName))
         return futureSingularName;
      else if (duration.isInPast() && pastSingularName != null && !TextUtils.isEmpty(pastSingularName))
   ...
   {
      if (duration.isInFuture() && futurePluralName != null && !TextUtils.isEmpty(futurePluralName))
         return futurePluralName;
      else if (duration.isInPast() && pastPluralName != null && !TextUtils.isEmpty(pastPluralName))
